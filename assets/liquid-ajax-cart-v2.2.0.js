...
function A() {
  ...
  if (0 === q.length) return void E(!1);
  if (0 === q[0].length) return q.shift(), void A();
  const { requestType: t, body: e, options: n } = q[0][0];
  !(function (t, e, n, o) {
    var i;
    const { extraRequestOnError: s } = W,
      u = k(t);
    let c;
    t !== l && (c = e || {});
    const d = t === l ? "GET" : "POST",
      f = n.info || {},
      h = { requestType: t, endpoint: u, requestBody: c, info: f },
      p = [],
      m = [],
      b = new CustomEvent(v, {
        detail: {
    ...
    const g = new CustomEvent(y, {
      detail: {
        requestState: { requestType: t, endpoint: u, info: f, requestBody: c },
      },
    });
    if ((document.dispatchEvent(g), f.cancel))
      return (h.responseData = null), void L(n, o, h);
    if (
      null === (i = null == n ? void 0 : n.signal) || void 0 === i
        ? void 0
        : i.aborted
    )
      return (
        (h.responseData = null), (h.fetchError = "AbortError"), void L(n, o, h)
      );
    if (void 0 !== c) {
      let e;
      if (
        (c instanceof FormData || c instanceof URLSearchParams
          ? c.has("sections") && (e = c.get("sections").toString())
          : (e = c.sections),
        "string" == typeof e || e instanceof String || Array.isArray(e))
      ) {
        if (
          (Array.isArray(e) ? p.push(...e) : p.push(...e.split(",")),
          a === t && m.push(...p.slice(0, 5)),
          p.length > 5)
        ) {
          m.push(...p.slice(5));
          const t = p.slice(0, 5).join(",");
          c instanceof FormData || c instanceof URLSearchParams
            ? c.set("sections", t)
            : (c.sections = t);
        }
      ...
      fetch(u, q)
        ...
        .then((t) =>
          r(this, void 0, void 0, function* () {
            ...
            return (
              (h.responseData = t),
              !h.responseData.ok && s && m.unshift(...p.slice(0, 5)),
              m.length > 0 &&
                ((null === (e = null == n ? void 0 : n.signal) || void 0 === e
                  ? void 0
                  : e.aborted) ||
                  (h.extraResponseData = yield S(
                    m,
...
function L(t, e, n) {
  ...
  const o = { requestState: n },
    i = new CustomEvent(b, { detail: o });
  document.dispatchEvent(i);
  const r = new CustomEvent(g, { detail: o });
...
function S(t = [], e) {
  const n = { updates: {} };
  return (
    t.length > 0 && (n.sections = t.slice(0, 5).join(",")),
    fetch(k(u), {
      method: "POST",
      ...
      n.json().then((o) => {
        const i = { ok: n.ok, status: n.status, body: o };
        return t.length < 6
          ? i
          : S(t.slice(5), e).then((t) => {
              var e;
              return (
                t.ok &&
                  ...
                  ("sections" in i.body || (i.body.sections = {}),
                  (i.body.sections = Object.assign(
                    Object.assign({}, i.body.sections),
                    t.body.sections
                  ))),
                i
              );
...
function j(t = {}) {
  w({ requestType: l, body: void 0, options: t });
}
function x(t = {}, e = {}) {
  w({ requestType: a, body: t, options: e });
}
function C(t = {}, e = {}) {
  w({ requestType: s, body: t, options: e });
}
function T(t = {}, e = {}) {
  w({ requestType: u, body: t, options: e });
}
function D(t = {}, e = {}) {
  w({ requestType: c, body: t, options: e });
}
function k(t) {
  ...
  switch (t) {
    ...
    case l:
      return `${
        (null ===
          (d =
            null === (r = window.Shopify) || void 0 === r
              ? void 0
              : r.routes) || void 0 === d
          ? void 0
          : d.root) || "/"
      ...
      t.textContent = (function (t) {
        ...
        return (
          ...
          i instanceof Number
            ? i.toString()
            : (console.error(
                `Liquid Ajax Cart: the calculated value for the ${B}="${t}" element must be string or number. But the value is`,
                i
              ),
              "")
        );
...
function Z(t) {
  const e = t.shift();
  if (e) {
    if (e.type && [a, s, u, c, l].includes(e.type))
      return void w({
        requestType: e.type,
        body: e.body,
        options: {
  ...
  connectedCallback() {
    ...
    if (1 !== o.length)
      return void console.error(
        `Liquid Ajax Cart: "${Q}" element must have one "form" element as a child, ${o.length} found`,
        n
      );
    const i = o[0];
    ...
    `${
      ...
      : console.error(
          `Liquid Ajax Cart: "${Q}" element's form "action" attribute value isn't a product form action URL`,
          i,
          n
        );
  }
}
var et, nt, ot, it, rt, at, st, ut;
const ct = `${
    (null ===
      (nt =
        null === (et = window.Shopify) || void 0 === et ? void 0 : et.routes) ||
    void 0 === nt
      ? void 0
      : nt.root) || "/"
  }cart/change`,
  lt = `${
    (null ===
      (it =
        null === (ot = window.Shopify) || void 0 === ot ? void 0 : ot.routes) ||
    void 0 === it
      ? void 0
      : it.root) || "/"
  }cart/add`,
  dt = `${
    (null ===
      (at =
        null === (rt = window.Shopify) || void 0 === rt ? void 0 : rt.routes) ||
    void 0 === at
      ? void 0
      : at.root) || "/"
  }cart/clear`,
  ft = `${
    (null ===
      (ut =
        null === (st = window.Shopify) || void 0 === st ? void 0 : st.routes) ||
    void 0 === ut
      ? void 0
      : ut.root) || "/"
  }cart/update`,
  ...
  if (i) {
    ...
    try {
      if (((t = new URL(i, window.location.origin)), !o.includes(t.pathname)))
        throw `URL should be one of the following: ${ct}, ${lt}, ${ft}, ${dt}`;
      n = t;
    } catch (t) {
      console.error(
    ...
    o.includes(e.pathname)
      ...
      : t.hasAttribute(ht) &&
        console.error(
          ...
          `URL should be one of the following: ${ct}, ${lt}, ${ft}, ${dt}`
        );
  }
  if (void 0 === n)
    return void console.error(
...
const vt = `${e}-quantity-input`;
function yt(t) {
  return !(
    !t.hasAttribute(vt) ||
    (!(
      (t instanceof HTMLInputElement && ["text", "number"].includes(t.type)) ||
      (t instanceof HTMLSelectElement && ["select-one"].includes(t.type))
    ) &&
      (console.error(
        `Liquid Ajax Cart: the ${vt} attribute supports "input" elements of types "text", "number" and non-multiple "select" elements`
      ),
      1))
  );
}
function bt() {
  document.querySelectorAll(`input[${vt}], select[${vt}]`).forEach((t) => {
    if (!yt(t)) return;
    if (_()) return void (t.disabled = !0);
    const e = M(),
      n = t.getAttribute(vt).trim(),
      [o] = mt(n, e);
...
function gt(t, e) {
  ...
  const o = t.getAttribute(vt).trim();
  if (isNaN(n))
    return void console.error(
      `Liquid Ajax Cart: input value of a ${vt} must be an Integer number`
    );
  if ((n < 1 && (n = 0), !o))
    return void console.error(
      `Liquid Ajax Cart: attribute value of a ${vt} must be an item key or an item index`
    );
...
function Et() {
  document.querySelectorAll(`[${qt}]`).forEach((t) => {
    if (!wt(t)) return;
    if (_()) return void (t.disabled = !0);
    const { objectCode: e, propertyName: n, attributeValue: o } = At(t);
    if (!e) return;
    const i = M();
    let r,
      a = !1;
...
function Lt(t, e) {
  ...
  const n = M();
  if (_()) return;
  const { objectCode: o, propertyName: i, attributeValue: r } = At(t);
  if (!o) return;
  let a = t.value;
  ...
  if ("note" === o) {
    ...
    e.set("note", a), T(e, { info: { initiator: t } });
  } else if ("attributes" === o) {
    const e = new FormData();
    e.set(`attributes[${i}]`, a), T(e, { info: { initiator: t } });
  } else {
    const [e, s] = mt(o, n);
    if (
      (null === e &&
  ...
  customElements.define(Q, tt),
    ...
    document.addEventListener(
      ...
      function (t) {
        const e = t.target;
        "Enter" === t.key &&
          ((e instanceof HTMLTextAreaElement && !t.ctrlKey) || Lt(e, t)),
          "Escape" === t.key &&
            (function (t) {
              if (!wt(t)) return;
              if (
              ...
              if (
                ...
                return;
              const e = M(),
                { objectCode: n, propertyName: o } = At(t);
              if (!n) return;
              let i;
    ...
    document.addEventListener(f, Et),
    document.addEventListener(b, Et),
    document.addEventListener(p, Et),
    Et(),
    document.addEventListener(
      "change",
      function (t) {
    ...
    document.addEventListener(
      "keydown",
      function (t) {
        "Enter" === t.key && gt(t.target, t),
          "Escape" === t.key &&
            (function (t) {
              if (!yt(t)) return;
              const e = t.getAttribute(vt).trim();
              let n;
              const o = M();
    ...
    document.addEventListener(f, bt),
    document.addEventListener(b, bt),
    document.addEventListener(p, bt),
    bt(),
    customElements.define(
      ...
      class extends HTMLElement {
        ...
        connectedCallback() {
          ...
          1 === t.length
            ? ((this._$input = t[0]),
              this._$input.hasAttribute(vt)
                ? ((this._$buttons = Array.from(
                    this.querySelectorAll(`[${xt}], [${jt}]`)
                  )),
                  ...
                  document.addEventListener(b, this._updateDOM.bind(this)),
                  document.addEventListener(p, this._updateDOM.bind(this)),
                  this._updateDOM(),
                  this._$buttons.forEach((t) => {
                    t.addEventListener("click", (e) => {
                      const { quantityTagAllowZero: n } = W,
                        o = !0 === n ? 0 : 1;
                      if (!_()) {
                        const e = Number(this._$input.value);
                        if (isNaN(e))
                          return void console.error(
                            `Liquid Ajax Cart: "${St}" element's input value isn't a number`,
                            this._$input,
                            this
                          );
                        let n = e,
                          i = Number(this._$input.getAttribute("step") || 1);
                        (!Number.isSafeInteger(i) || i <= 0) && (i = 1),
                          (n = t.hasAttribute(jt) ? n + i : n - i),
                          n < o && (n = o),
                          n !== e &&
                ...
                : console.error(
                    `Liquid Ajax Cart: "${St}" element's input must have the "${vt}" attribute`,
                    this._$input,
                    this
                  ))
            : console.error(
                `Liquid Ajax Cart: "${St}" element must have one "input" element as a child, ${t.length} found`,
                this
              );
        }
        _runAwaiting() {
          const { quantityTagDebounce: t } = W;
      ...
      case a:
        return ((t) => {
          ...
          return n instanceof tt
            ? Array.from(n.querySelectorAll(`[${Tt}="form"]`))
            : [];
        })(t);
      case s:
        return ((t) => {
          ...
          if (
            ...
            t.requestBody instanceof URLSearchParams
              ...
              : ("line" in t.requestBody && (r = String(t.requestBody.line)),
            ...
            if (t > 0) {
              const n = t - 1;
              i =
                null === (e = o.cart.items[n]) || void 0 === e ? void 0 : e.key;
            }
          }
          return (
            i &&
              (i.indexOf(":") > -1
                ? n.push(
                    ...Array.from(document.querySelectorAll(`[${Tt}="${i}"]`))
                  )
                : n.push(
                    ...Array.from(
...
function Rt() {
  const t = document.querySelector("html"),
    e = M();
  t.classList.toggle(kt, null !== e.cart),
    t.classList.toggle(_t, _()),
    t.classList.toggle(Ot, 0 === e.cart.item_count),
    t.classList.toggle(Nt, e.cart.item_count > 0);
}
let Mt = !1;
if (!("liquidAjaxCart" in window)) {
  ...
  (window.liquidAjaxCart = {
      ...
      t in W
        ? ((W[t] = e),
          window.liquidAjaxCart.init &&
            ("binderFormatters" === t && H(), "mutations" === t && J()))
        : console.error(
      ...
      if (void 0 !== e.requestBody) {
        ...
        if (
          (document.querySelectorAll(`[${z}]`).forEach((e) => {
            ...
            if (n) {
              const e = n.id.replace(X, "");
              -1 === t.indexOf(e) && t.push(e);
            } else
              console.error(
                `Liquid Ajax Cart: there is a ${z} element that is not inside a Shopify section. All the ${z} elements must be inside Shopify sections.`
              );
          }),
          t.length)
        ) {
    ...
    document.addEventListener(b, (t) => {
      var e, n, o, i;
      t.detail.sections = [];
      const { requestState: r } = t.detail,
        s = new DOMParser(),
        u = [];
      if (
        r.responseData.body.sections ||
        (null ===
          (n =
            null === (e = r.extraResponseData) || void 0 === e
              ? void 0
              : e.body) || void 0 === n
          ? void 0
          : n.sections)
        ...
        (null ===
          (i =
            null === (o = r.extraResponseData) || void 0 === o
              ? void 0
              : o.body) || void 0 === i
          ? void 0
          : i.sections) &&
          (t = Object.assign(
            Object.assign({}, t),
            r.extraResponseData.body.sections
          ));
        for (let e in t)
          t[e]
            ? document
                ...
                .forEach((n) => {
                  ...
                  if (f) {
                    const r = s.parseFromString(t[e], "text/html");
                    ...
                    const a = r.querySelectorAll(`[${z}]`);
                    if (f.length !== a.length) {
                      console.error(
                        `Liquid Ajax Cart: the received HTML for the "${e}" section has a different quantity of the "${z}" containers. The section will be updated completely.`
                      );
                  ...
                  o.length > 0 && u.push({ id: e, elements: o });
                })
            : console.error(
    ...
    document.addEventListener(b, (t) => {
      ...
      const o = (function (t) {
        ...
        const c =
          ...
          (null ===
            (s =
              null === (a = t.responseData) || void 0 === a
                ? void 0
                : a.body) || void 0 === s
            ? void 0
            : s.message);
    ...
    (function () {
      ...
      if (t)
        try {
          ...
          console.error(
            `Liquid Ajax Cart: can't parse cart JSON from the "${O}" script`
          ),
            console.error(t);
        }
      ...
      document.addEventListener(b, H),
        H(),
        Ct(),
        document.addEventListener(f, Rt),
        document.addEventListener(b, Rt),
        document.addEventListener(p, Rt),
        Rt(),
        (window.liquidAjaxCart.get = j),
        (window.liquidAjaxCart.add = x),
        (window.liquidAjaxCart.change = C),
        (window.liquidAjaxCart.update = T),
        (window.liquidAjaxCart.clear = D),
        Bt("cart", () => M().cart),
        Bt("processing", _),
